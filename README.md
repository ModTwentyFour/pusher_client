...
[![GitHub license](https://img.shields.io/badge/license-MIT-lightgrey.svg)](https://raw.githubusercontent.com/modtwentyfour/pusher_client/master/LICENSE)
![Languages](https://img.shields.io/badge/languages-dart%20%7C%20kotlin%20%7C%20swift-blueviolet.svg)
[![Twitter](https://img.shields.io/badge/twitter-@modtwentyfour-blue.svg?style=flat&logo=twitter)](https://twitter.com/modtwentyfour)

A Pusher Channels client plugin for Flutter targeting Android and iOS. It wraps
[pusher-websocket-java](https://github.com/pusher/pusher-websocket-java) v2.4.4 and [pusher-websocket-swift](https://github.com/pusher/pusher-websocket-swift) v9.0.0.
...
```pro
-keep class com.github.modtwentyfour.pusher_client.** { *; }
```
